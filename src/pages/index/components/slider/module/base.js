...
class BaseSlider {
  constructor(el, options) {
    // 判断传入的el是不是DOM节点，el.nodeType === 1 时，el为DOM节点
    ...
    const sliderEl = el;
    const sliderContentEl = sliderEl.querySelector('.slider__content');
    const sliderItemEls = sliderContentEl.querySelectorAll('.slider__item');
